...
class SolomojiProcessor {
    ...
    extractEmojis(chatContent) {
        // Improved emoji regex that captures all Unicode emoji ranges
        ...
        const emojis = [];
        const processedMessages = new Set(); // To avoid duplicates from system messages
        ...
        lines.forEach(line => {
            ...
            if (messageMatch) {
                ...
                // Skip if we've already processed this exact message (avoid duplicates)
